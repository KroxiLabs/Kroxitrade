...
const portugueseTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Restaurar painel do Kroxitrade",
  "popup.description": "Kroxitrade adiciona navegação mais rápida e ferramentas de trade ao site oficial de Path of Exile.",
  "settings.sidebarTitle": "Posição do painel",
  "settings.sidebarDescription": "Escolha em qual lado da tela o painel do Kroxitrade deve aparecer.",
  ...
  "about.eyebrow": "Sobre",
  "about.description": "Kroxitrade é um complemento para o Path of Exile Trade criado para salvar buscas, organizar pastas, acompanhar o histórico e manter fluxos de trade recorrentes rápidos, visuais e fáceis de gerenciar dentro do site oficial.",
...
const germanTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Kroxitrade-Panel wiederherstellen",
  "popup.description": "Kroxitrade fügt der offiziellen Path of Exile-Handelsseite schnellere Navigation und Handelshilfen hinzu.",
  "settings.sidebarTitle": "Position der Seitenleiste",
  "settings.sidebarDescription": "Wähle, auf welcher Seite des Bildschirms das Kroxitrade-Panel erscheinen soll.",
  "settings.left": "Links",
  ...
  "about.description": "Kroxitrade ist ein Begleiter für Path of Exile Trade, entwickelt zum Speichern von Suchen, Organisieren von Ordnern, Nachverfolgen des Verlaufs und für schnelle, übersichtliche wiederkehrende Handelsabläufe direkt auf der offiziellen Seite.",
...
const frenchTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Restaurer le panneau Kroxitrade",
  "popup.description": "Kroxitrade ajoute une navigation plus rapide et des aides de trade au site officiel de Path of Exile.",
  "settings.sidebarTitle": "Position du panneau",
  "settings.sidebarDescription": "Choisissez de quel côté de l’écran le panneau Kroxitrade doit apparaître.",
  ...
  "about.description": "Kroxitrade est un compagnon pour Path of Exile Trade conçu pour sauvegarder des recherches, organiser des dossiers, suivre l’historique et garder les routines de trade rapides, visuelles et faciles à gérer directement sur le site officiel.",
...
const russianTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Восстановить панель Kroxitrade",
  "popup.description": "Kroxitrade добавляет более быструю навигацию и торговые инструменты на официальный сайт торговли Path of Exile.",
  "settings.sidebarTitle": "Положение панели",
  "settings.sidebarDescription": "Выберите сторону экрана, где будет отображаться панель Kroxitrade.",
  "settings.left": "Слева",
  ...
  "about.description": "Kroxitrade — это дополнение для торговли Path of Exile, созданное для сохранения поисков, организации папок, отслеживания истории и удобной работы с повторяющимися торговыми сценариями прямо на официальном сайте.",
...
const thaiTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "กู้คืนแผง Kroxitrade",
  "popup.description": "Kroxitrade เพิ่มการนำทางที่เร็วขึ้นและเครื่องมือช่วยเทรดให้กับเว็บไซต์ซื้อขาย Path of Exile อย่างเป็นทางการ",
  "settings.sidebarTitle": "ตำแหน่งแผง",
  "settings.sidebarDescription": "เลือกด้านของหน้าจอที่ต้องการให้แผง Kroxitrade แสดงผล",
  "settings.left": "ซ้าย",
  "settings.right": "ขวา",
  ...
  "about.description": "Kroxitrade เป็นส่วนเสริมสำหรับ Path of Exile Trade ที่สร้างขึ้นเพื่อบันทึกการค้นหา จัดระเบียบโฟลเดอร์ ติดตามประวัติ และทำให้การซื้อขายที่ทำซ้ำบ่อยรวดเร็ว มองเห็นได้ง่าย และจัดการได้สะดวกภายในเว็บไซต์ทางการ",
...
const japaneseTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Kroxitrade パネルを復元",
  "popup.description": "Kroxitrade は Path of Exile 公式トレードサイトに、より高速なナビゲーションと取引支援機能を追加します。",
  ...
  "settings.sidebarDescription": "Kroxitrade パネルを画面のどちら側に表示するか選択してください。",
  "settings.left": "左",
  "settings.right": "右",
  ...
  "settings.visible": "表示",
  "about.eyebrow": "概要",
  "about.description": "Kroxitrade は Path of Exile Trade 用の補助ツールで、検索の保存、フォルダー整理、履歴管理を行い、繰り返し使うトレード作業を公式サイト上で素早く見やすく簡単に管理できるようにします。",
...
const koreanTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Kroxitrade 패널 복원",
  "popup.description": "Kroxitrade는 공식 Path of Exile 거래 사이트에 더 빠른 탐색과 거래 도우미 기능을 추가합니다.",
  ...
  "settings.sidebarDescription": "Kroxitrade 패널을 화면 어느 쪽에 표시할지 선택하세요.",
  "settings.left": "왼쪽",
  "settings.right": "오른쪽",
  ...
  "settings.visible": "표시",
  "about.eyebrow": "정보",
  "about.description": "Kroxitrade는 Path of Exile Trade용 보조 도구로, 검색 저장, 폴더 정리, 기록 추적을 지원하며 반복적인 거래 작업을 공식 사이트 안에서 빠르고 보기 쉽게 관리할 수 있게 해줍니다.",
