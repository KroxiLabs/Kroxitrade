/**
 * Curated Simplified-Chinese Bestiary names. The item-search list carries only
 * English names; the cache derives Traditional names from stable static-data
 * slugs, while these entries cover terms that differ beyond OpenCC conversion.
 *
 * Keys are normalized English names. Names not listed here use the OpenCC
 * conversion of their Traditional equivalent.
 */
